...
# for DGI model
Epoch = 500
h_dim = 256  # Embedding Dimension h
n_layers = 2  # Balance constant b
...
# %% Initialize LG-VGAE
model = DGI(g, 165, h_dim, n_layers, activation, dropout).to(device)

DGI_optimizer = torch.optim.Adam(model.parameters(), lr=0.001, weight_decay=1e-4)

# %%
# train DGI using early stop strategy
